...
#Part 1 错误分类
def _classify_batch_confirm_items_error(e: Exception) -> tuple[ErrorType, str, str]:
...
def batch_confirm_items_tool(args: dict) -> ToolResult:
    ...
    try:
        ...
        result = service.batch_confirm_items(
        ...
        db.rollback()
        error_type,explanation,msg =_classify_batch_confirm_items_error(e)
        return ToolResult( 
            ok=False,
            tool_name="batch_confirm_items_tool",
...
tool_registry.register(ToolSpec(
    name="batch_confirm_items_tool",
    func=batch_confirm_items_tool,
    description="""Batch confirm warning items and trigger file validation.
